        ...
        <div className="flex flex-col min-h-screen" ref={sectionRef}>
          ...
          <section className="h-screen pl-8 lg:pl-28 flex flex-col justify-center intro-animate">
            <div className="flex flex-col lg:flex-row lg:items-center">
              <div>
                <span className="text-black font-bold text-8xl intro-animate-text">ALPHA</span>
                <div className="font-bold text-8xl bg-clip-text text-transparent bg-gradient-to-b from-gradient-1 to-gradient-2 intro-animate-text">
          ...
          {/* Other Sections */}
          <section className="h-screen p-8 lg:p-28 flex flex-col justify-center bg-black animate-section">
            <h1 className="text-4xl lg:text-5xl font-semibold text-left mb-8 lg:mb-12 text-white animate-text">Your Gateway to Robotics</h1>
            <div className="flex flex-col lg:flex-row lg:items-center">
              <div className="mb-8 lg:mb-0 pr-8 text-white animate-text">
          ...
          <section className="h-screen px-8 lg:px-28 flex flex-col justify-center pt-48 animate-section">
            <h1 className="text-4xl lg:text-5xl font-semibold text-left mb-4 lg:mb-6 bg-clip-text text-transparent bg-gradient-to-r from-gradient-1 to-gradient-2 animate-text">ROBOTICS CAPABILITIES</h1>
            <div className="flex flex-col">
              <span className="text-3xl text-black animate-text">The 12 Degrees of Freedom allows Precision control and</span>
              <span className="text-3xl text-black animate-text">Inverse kinematics. This creates several advantages over</span>
              <span className="text-3xl text-black animate-text">other Kits.</span>
            </div>
            <hr className="border-t-2 border-gray-500 my-8 lg:my-6 animate-text" />
            <div className="flex justify-center gap-8 mt-4">
              <div className="flex-1 max-w-lg rounded-lg animate-image">
                <Image height="500" width="500" src="/bot3.png" alt="robot3" className="w-full h-auto object-cover rounded-l-3xl" />
              </div>
              <div className="flex-1 max-w-lg bg-black rounded-r-3xl animate-image">
                <Image height="500" width="500" src="/bot4.png" alt="robot4" className="w-full h-auto object-cover rounded-r-3xl" />
              </div>
            </div>
          </section>

          <section className="flex flex-col justify-center items-center mt-52 mx-28 animate-section">
            <div className="relative flex justify-center items-center w-full bg-black h-screen rounded-3xl animate-image">
              ...
              <div className="absolute flex flex-col bottom-20 left-16 text-white text-3xl font-bold animate-text">
          ...
          <hr className="border-t-2 border-gray-500 lg:my-16 mx-24 animate-section" />

          <section className="h-screen flex flex-col px-32 pt-6 animate-section">
            <h1 className="text-5xl lg:text-6xl font-bold text-left mb-4 lg:mb-6 bg-clip-text text-transparent bg-gradient-to-r from-gradient-1 to-gradient-2 animate-text">
              Vision with Depth
            </h1>
          ...
          <section className="h-screen flex flex-col justify-center animate-section">
            <h1 className="text-5xl lg:text-6xl font-bold text-center mb-6 lg:mb-12 animate-text">Join the Future of Robotics</h1>
            <div className="flex flex-col items-center text-center text-2xl lg:text-3xl text-black">
              ...
              <button className="mt-8 bg-gradient-to-r from-gradient-1 to-gradient-2 text-white py-4 px-8 rounded animate-text">Preorder Now</button>
            </div>
          </section>
        </div>
      </div>
